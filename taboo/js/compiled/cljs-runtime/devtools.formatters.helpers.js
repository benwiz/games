...
var G__40497 = devtools.prefs.pref(v);
v = G__40497;
continue;
} else {
return v;
...
}catch (e40437){var _e__39270__auto__ = e40437;
return false;
}})();
...
}catch (e40442){var _e__39270__auto__ = e40442;
return false;
}})();
...
}catch (e40444){var _e__39270__auto__ = e40444;
return false;
}}
}
});
...
var vec__40466 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40466,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40466,(1),null);
...
return cljs.core.some((function (p1__40480_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40480_SHARP_);
}),template);
});
